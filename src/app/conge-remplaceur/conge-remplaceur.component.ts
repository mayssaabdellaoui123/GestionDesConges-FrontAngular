...
@Component({
  selector: 'app-conge-remplaceur',
  templateUrl: './conge-remplaceur.component.html',
  styleUrls: ['./conge-remplaceur.component.css']
})
export class CongeRemplaceurComponent implements OnInit {
 ...
 public show:boolean = false;
  ...
  ngOnInit(): void {
    ...
    this.info = {
      ...
      this.GetCongesForRemplaceur(this.info.username);
  }
  ...
  public GetCongesForRemplaceur(username:string): void {
    this.serviceConge.GetCongesForRemplaceur(username).subscribe(
      (response: Conge1[]) => {
        this.Conge = response;
  ...
  public ValidationPrimaireRemplaceur(): void {
    this.serviceConge.ValidationPrimaireRemplaceur(this.idConge,this.info.username).subscribe(
      (response:void) => {
...
/************************************************************************ */
  ...
  AnnuleValidationPrimaireRemplaceur(){
    console.log(this.AvisPrimaireSaisie);
    this.serviceConge.AnnuleValidationPrimaireRemplaceur(this.idConge,this.info.username,this.AvisPrimaireSaisie).subscribe(
      (response:void) => {
        console.log("id conge inside ValidationPrimaireChefDep : "+ this.idConge );
